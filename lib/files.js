...
// Broader than HERMES_HOME on purpose — mirrors the old build's /home/user-rooted
// Files browser, which could reach the whole app area (workspace, config, app code),
// not just the data dir.
const FILES_ROOT = path.resolve(process.env.FILES_ROOT || "/opt");
