...
def setup_keepalive_worker(api_token: str, account_id: str, subdomain: str) -> None:
    ...
    # Once a day by default — pinging every few minutes keeps a free-tier Space
    # awake around the clock, which Hugging Face's abuse detection has flagged
    # as scraping/abuse on real Spaces. A single daily ping is enough to stop
    # the Space from being fully unloaded; it will still cold-start on demand.
